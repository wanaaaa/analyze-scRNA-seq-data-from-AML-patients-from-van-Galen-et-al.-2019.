...
Seurat_so = SeuratFun(BM3_dem_tbl, BM3_annot_tbl)
CellTypeGrapFun(Seurat_so, "BM3 normal1 CellType")
PredicRefinedGrapFun(Seurat_so, "BM3 normal1 Prediction")
...
Seurat_so = SeuratFun(BM4_dem_tbl, BM4_annot_tbl)
CellTypeGrapFun(Seurat_so, "BM4 normal2 CellType")
PredicRefinedGrapFun(Seurat_so, "BM4 normal2 Prediction")
...
Seurat_so = SeuratFun(BM5.34p_dem_tbl, BM5.34p_annot_tbl)
CellTypeGrapFun(Seurat_so, "BM5.34p normal3 CellType")
PredicRefinedGrapFun(Seurat_so, "BM5.34p normal3 Prediction")
...
Seurat_so = SeuratFun(BM5.34p38n_dem_tbl, BM5.34p38n_annot_tbl)
CellTypeGrapFun(Seurat_so, "BM5.34p38n normal4 CellType")
PredicRefinedGrapFun(Seurat_so, "BM5.34p38n normal4 Prediction")
...
Seurat_so = SeuratFun(AML916_dem_tbl, AML916_annot_tbl)
CellTypeGrapFun(Seurat_so, "AML916 sick3 CellType")
PredicRefinedGrapFun(Seurat_so, "AML916 sick3 Prediction")
...
Seurat_so = SeuratFun(AML921_dem_tbl, AML921_annot_tbl)
CellTypeGrapFun(Seurat_so, "AML921 sick4 CellType")
PredicRefinedGrapFun(Seurat_so, "AML921 sick4 Prediction")
